...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC3)
  {
    ...
    PH4     ------> ADC3_INP15
    */
    HAL_GPIO_DeInit(GPIOF, VOL_DET_Pin|MIC_G_Pin|SWR_DET_Pin|SQ_DET_Pin
                          |BATT_Pin|SQ_Pin);

    HAL_GPIO_DeInit(GPIOC, BPF_TUNE_Pin|ASQ_Pin|RX_RSSI_Pin);

    HAL_GPIO_DeInit(GPIOH, CDT_DET_Pin|VOX_DET_Pin|FINM_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI5)
  {
    ...
    PH7     ------> SPI5_MISO
    */
    HAL_GPIO_DeInit(GPIOF, TCH_CLK_Pin|TCH_MOSI_Pin);
