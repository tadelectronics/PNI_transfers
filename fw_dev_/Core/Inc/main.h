...
#define VOL_DET_Pin GPIO_PIN_3
#define VOL_DET_GPIO_Port GPIOF
#define MIC_G_Pin GPIO_PIN_4
#define MIC_G_GPIO_Port GPIOF
#define SWR_DET_Pin GPIO_PIN_6
#define SWR_DET_GPIO_Port GPIOF
#define TCH_CLK_Pin GPIO_PIN_7
#define TCH_CLK_GPIO_Port GPIOF
#define SQ_DET_Pin GPIO_PIN_8
#define SQ_DET_GPIO_Port GPIOF
#define BATT_Pin GPIO_PIN_9
#define BATT_GPIO_Port GPIOF
#define SQ_Pin GPIO_PIN_10
#define SQ_GPIO_Port GPIOF
#define TCH_INT_Pin GPIO_PIN_0
#define TCH_INT_GPIO_Port GPIOC
...
#define ANI_VOX_Pin GPIO_PIN_15
#define ANI_VOX_GPIO_Port GPIOB
...
#define ESCL_Pin GPIO_PIN_8
#define ESCL_GPIO_Port GPIOA
#define PA_ENB_Pin GPIO_PIN_10
#define PA_ENB_GPIO_Port GPIOA
#define B_EN_Pin GPIO_PIN_13
#define B_EN_GPIO_Port GPIOH
#define PTT_Pin GPIO_PIN_14
#define PTT_GPIO_Port GPIOH
#define TCH_NCS_Pin GPIO_PIN_15
#define TCH_NCS_GPIO_Port GPIOH
#define RT_EN_Pin GPIO_PIN_0
#define RT_EN_GPIO_Port GPIOI
#define PUSH_Pin GPIO_PIN_2
#define PUSH_GPIO_Port GPIOI
