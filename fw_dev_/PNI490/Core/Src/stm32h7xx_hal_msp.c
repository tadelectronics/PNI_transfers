...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PH3     ------> ADC3_INP14
    */
    HAL_GPIO_DeInit(GPIOF, SWR_DET_Pin|BATT_Pin|SQ_Pin);

    HAL_GPIO_DeInit(GPIOC, ANI_VOX_Pin|BPF_TUNE_Pin|ASQ_Pin|RX_RSSI_Pin);

    HAL_GPIO_DeInit(GPIOH, CDT_DET_Pin|VOX_DET_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(PLL_CLK_GPIO_Port, PLL_CLK_Pin);

    HAL_GPIO_DeInit(PLL_DATA_GPIO_Port, PLL_DATA_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PF1     ------> I2C2_SCL
    */
    HAL_GPIO_DeInit(MDATA_GPIO_Port, MDATA_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PH8     ------> I2C3_SDA
    */
    HAL_GPIO_DeInit(ESCL_GPIO_Port, ESCL_Pin);

    HAL_GPIO_DeInit(ESDA_GPIO_Port, ESDA_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI5_MspDeInit 0 */
    ...
    PF11     ------> SPI5_MOSI
    */
    HAL_GPIO_DeInit(GPIOF, TCH_CLK_Pin|TCH_MISO_Pin|TCH_MOSI_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PA0     ------> UART4_TX
    */
    HAL_GPIO_DeInit(RXD1_GPIO_Port, RXD1_Pin);

    HAL_GPIO_DeInit(TXD1_GPIO_Port, TXD1_Pin);
